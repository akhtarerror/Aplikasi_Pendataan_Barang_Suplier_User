...
Public Class DetailPenjualan
    ...
    Private Sub PrintPage(sender As Object, e As PrintPageEventArgs)
        ...
        Dim query As String = "SELECT penjualan.faktur, penjualan.tgl, penjualan.total, penjualan.bayar, penjualan.kembali, " &
                              "detailtransaksijual.nama_barang, detailtransaksijual.jumlah, detailtransaksijual.harga_satuan, detailtransaksijual.total " &
                              "FROM penjualan INNER JOIN detailtransaksijual ON penjualan.faktur = detailtransaksijual.faktur " &
                              "WHERE penjualan.faktur = @faktur"
